...
| **Revenue trackers**                   | Tracker-backed revenue governance aligned with recurring operational submissions (API-backed router). **Revenue forecast** view includes **Indian FY Q1 (AMJ)** quarter KPIs and a fixed **Apr–May–Jun** forecast-vs-MMF chart keyed to the governance week.                                                                             |
