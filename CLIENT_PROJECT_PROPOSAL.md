...
| A8 | **Weekly commercial tracking** | **Revenue trackers**: weekly **forecast** lines and **visibility** snapshots per project, maintainable from the application; **forecast** tab surfaces **AMJ (Apr–Jun)** quarter roll-ups and a three-month chart vs MMF (Indian FY from governance week). |
